...
models.load_fields("res.company", ['regimen_fiscal', 'zip', 'street', 'street2', 'city', 'state_id', 'nombre_fiscal']);
...
models.Order = models.Order.extend({
    ...
    export_for_printing: function(){
    	...
    	json.company.regimen_fiscal=this.pos.company.regimen_fiscal;
    	...
    	if(order.invoice_information) {
    		json.regimen_fiscal = order.invoice_information.regimen_fiscal;
            ...
            json.uso_cfdi = order.invoice_information.uso_cfdi;
            json.methodo_pago = order.invoice_information.methodo_pago;
            json.regimen_fiscal = order.invoice_information.regimen_fiscal;
            json.forma_pago = order.invoice_information.forma_pago;
